<template>
  <section class="container">
    ...
    <div class="content">
      ...
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ipsum urna, 
       ...
       <p>
        ...
        <p>Suspendisse eu rhoncus erat, quis vestibulum tellus. 
        ...
        <p>Vivamus convallis, metus eu varius iaculis, lorem nisl fermentum quam, quis suscipit leo erat 
    ...
    <div class="cooks">
        <h3>Cooks who serve this kind of hosting</h3>
        ...
        <div class="user-card">
           <img src="../images/cook4.jpg" class="cook_image" alt="">
            <span class="user-name">Tamara tabacha</span>
            <star-rating v-model="rating" 
            v-bind:star-size = "20"
            read-only = "true"
            :show-rating = "false"
